...
if(CONFIG_RISCV_TOOLCHAIN STREQUAL GNU_RVG)
  ...
  # openvela: disable gp-relative addressing. The flat SIMPLE_BOOT image
  # packs .sdata + huge .flash.rodata into one 512KB SRAM window, so
  # GP-relative loads to .rodata constants exceed the +/-2KB gp range and
  # fail with "relocation truncated to fit: R_RISCV_GPREL_I".
  list(APPEND ARCHCPUFLAGS -msmall-data-limit=0)
